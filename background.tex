...
Our more recent contributions that explore LLM-directed code optimization
...
\subsubsection{CPU architecture}\label{sec:cpu-architecture}
...
\subsubsection{GPU architecture}\label{sec:gpu-architecture}
...
\subsection{Summary}\label{sec:code-optimization-summary}
