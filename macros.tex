...
\lstdefinestyle{C++}{
  ...
  morekeywords={concept,requires,co_await,co_yield,co_return,consteval,constexpr,decltype,final,noexcept,override,static_assert,thread_local,assert,nullptr},
  classoffset=1,
