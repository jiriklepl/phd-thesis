...
\def\ThesisTitle{\xxx{Optimizing memory layouts of data structures designed for parallel systems}}
...
\def\ThesisTitleCS{\xxx{Optimalizace paměťových rozložení datových struktur určených pro paralelní systémy}}
