...
To better understand the motivation behind layout and traversal optimizations, we first outline the hardware features of modern high-performance systems that are most relevant to our focus on these optimizations.
