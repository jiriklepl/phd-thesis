...
\else\PackageError{thesis}{Unknown study language.}{Please check the definition of StudyLanguage in sources/shared/metadata.tex.}
\fi\fi
...
\lstdefinestyle{C++}{
  ...
  morekeywords={concept,requires,co_await,co_yield,co_return,consteval,constexpr,decltype,final,noexcept,override,static_assert,thread_local,assert,nullptr,__global__,__device__,__host__,__shared__,__constant__,__restrict__,T},
  classoffset=1,
  morekeywords={noarr,cellato,std,Kokkos,RAJA,ranges,views,nr},
  keywordstyle=\color{teal!75!black},
  classoffset=2,
  morekeywords={cudaMalloc,cudaFree},
  ...
  {__M}{{\textcolor{teal!25!purple}{M}}}1
  {__N}{{\textcolor{teal!25!purple}{N}}}1
  {__K}{{\textcolor{teal!25!purple}{K}}}1
  {__S}{{\textcolor{teal!25!purple}{S}}}1
  {__D}{{\textcolor{red!75!black}{D}}}1
  {__B}{{\textcolor{red!75!black}{B}}}1
}
\lstset{style=C++}
...
\newcommand{\contribref}[1]{\citetitle{#1}~\cite{#1} (\cref{contrib:#1})}
...
\newcommand{\publicationas}[2]{%
  \begin{description}
    \item[#1]\begin{refsection}\fullcite{#2}\end{refsection}
  \end{description}
}
\newcommand{\publishedas}[1]{\publicationas{Published as}{#1}}

\newcommand{\submittedmanuscriptnotice}{%
  \begingroup
  \small\noindent\emph{This preprint has not undergone peer review (when
  applicable) or any post-submission improvements or corrections.}\par
  \endgroup
}

\newcommand{\submittedas}[1]{%
  \publicationas{Submitted as}{#1}%
  \submittedmanuscriptnotice
}

\newcommand{\springerthesisnotice}{%
  \begingroup
  \small\noindent\emph{Reproduced with permission from Springer Nature.}\par
  \endgroup
}

\newcommand{\ccbythesisnotice}{%
  \begingroup
  \small\noindent This work is licensed under the Creative Commons
  Attribution 4.0 International License (CC BY 4.0),
  \url{https://creativecommons.org/licenses/by/4.0/}. Reproduced without changes.\par
  \endgroup
}

\newcommand{\springerpublishedas}[1]{%
  \publishedas{#1}%
  \springerthesisnotice
}

\newcommand{\ccpublishedas}[1]{%
  \publishedas{#1}%
  \ccbythesisnotice
}
