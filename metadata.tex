...
\def\ThesisTitle{Optimizing memory layouts of data structures designed for parallel systems}
...
\def\ThesisTitleCS{Optimalizace paměťových rozložení datových struktur určených pro paralelní systémy}
