...
\lstdefinestyle{C++}{
  ...
  morekeywords={concept,requires,co_await,co_yield,co_return,consteval,constexpr,decltype,final,noexcept,override,static_assert,thread_local,assert,nullptr,__global__,__device__,__host__,__shared__,__constant__,__restrict__},
  classoffset=1,
